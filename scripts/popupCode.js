const popupData = [
    {
        ...
        text: 'Макети дизайна создается с нуля для каждого случая, в портфолио 3 года опыта дизайнерской деятельности. А также весь дизайн полностью согласуется с заказчиком и правится, при необходимости.',
    }, {
        title: 'JS наше все',
